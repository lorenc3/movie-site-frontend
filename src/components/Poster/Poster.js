...
class Poster extends Component {
  ...
  render() {
    ...
    var date = new Date(item.release_date).toLocaleDateString("en-US", options);
    ...
    return (
      <div className="container">
        <img
          ...
          src={`https://image.tmdb.org/t/p/w${size}${item.poster_path}`}
          alt="poster"
        />
        <div className="overlay" style={{ borderRadius: radius }}>
          ...
          {bookmark !== null ? (
            ...
            >
              <button className="iconBox" onClick={this.bookmarkMovie}>
                {bookmark ? <MdBookmark /> : <MdBookmarkBorder />}
              </button>
            </IconContext.Provider>
          ) : null}
        </div>
